			...
			<?php endif; ?> 			
				...
				<div id="contact">
					...
					<div id="newsletter">
						...
						<input type="text" class="email_sub_field" name="emailtosubscribe" id="emailtosubscribe" /><input type="button" class="email_sub_button" name="emailsubscribesubmit" id="emailsubscribesubmit" value="Join" /><br /><div id="email_sub_response" class="font12 redtext"></div>
					</div>				
					<script type="text/javascript">
						...
						$("#emailsubscribesubmit").click(function(){
							...
							var dataString = "email="+email+"&emailsubscription=go";
							//alert(dataString);
							$.ajax({
								type: "POST",
								url: "<?php bloginfo('stylesheet_directory'); ?>/ec/inc/store-address.php",
								data: dataString,
